...
if os.path.exists('data/dev_component_predictions/title_predictions.pkl') and os.path.exists('data/dev_component_predictions/title_not_ranked.pkl'):
    with open('data/dev_component_predictions/title_predictions.pkl', 'rb') as f:
        predictions_td = pickle.load(f)
    with open('data/dev_component_predictions/title_not_ranked.pkl', 'rb') as f:
        not_ranked_td = pickle.load(f)
else:
    predictions_td, not_ranked_td = rank_by_title(current_queries_dict, data_dict)
    with open('data/dev_component_predictions/title_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_td, f)
    with open('data/dev_component_predictions/title_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/quote_predictions.pkl') and os.path.exists('data/dev_component_predictions/quote_not_ranked.pkl'):
    with open('data/dev_component_predictions/quote_predictions.pkl', 'rb') as f:
        predictions_qd = pickle.load(f)
    with open('data/dev_component_predictions/quote_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/quote_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_qd, f)
    with open('data/dev_component_predictions/quote_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/summary_predictions.pkl') and os.path.exists('data/dev_component_predictions/summary_not_ranked.pkl'):
    with open('data/dev_component_predictions/summary_predictions.pkl', 'rb') as f:
        predictions_sus = pickle.load(f)
    with open('data/dev_component_predictions/summary_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/summary_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_sus, f)
    with open('data/dev_component_predictions/summary_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/bm25_abstracts_predictions.pkl') and os.path.exists('data/dev_component_predictions/bm25_abstracts_not_ranked.pkl'):
    with open('data/dev_component_predictions/bm25_abstracts_predictions.pkl', 'rb') as f:
        predictions_bm25 = pickle.load(f)
    with open('data/dev_component_predictions/bm25_abstracts_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/bm25_abstracts_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_bm25, f)
    with open('data/dev_component_predictions/bm25_abstracts_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/specter_predictions.pkl') and os.path.exists('data/dev_component_predictions/specter_not_ranked.pkl'):
    with open('data/dev_component_predictions/specter_predictions.pkl', 'rb') as f:
        predictions_specs = pickle.load(f)
    with open('data/dev_component_predictions/specter_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/specter_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_specs, f)
    with open('data/dev_component_predictions/specter_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/mpnet_predictions.pkl') and os.path.exists('data/dev_component_predictions/mpnet_not_ranked.pkl'):
    with open('data/dev_component_predictions/mpnet_predictions.pkl', 'rb') as f:
        predictions_mpnet = pickle.load(f)
    with open('data/dev_component_predictions/mpnet_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/mpnet_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_mpnet, f)
    with open('data/dev_component_predictions/mpnet_not_ranked.pkl', 'wb') as f:
...
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
# if os.path.exists('data/dev_component_predictions/scibert_predictions.pkl') and os.path.exists('data/dev_component_predictions/scibert_not_ranked.pkl'):
#     with open('data/dev_component_predictions/scibert_predictions.pkl', 'rb') as f:
#         predictions_scis = pickle.load(f)
#     with open('data/dev_component_predictions/scibert_not_ranked.pkl', 'rb') as f:
...
#     with open('data/dev_component_predictions/scibert_predictions.pkl', 'wb') as f:
#         pickle.dump(predictions_scis, f)
#     with open('data/dev_component_predictions/scibert_not_ranked.pkl', 'wb') as f:
...
# if os.path.exists('data/dev_component_predictions/bm25_whole_predictions.pkl') and os.path.exists('data/dev_component_predictions/bm25_whole_not_ranked.pkl'):
#     with open('data/dev_component_predictions/bm25_whole_predictions.pkl', 'rb') as f:
#         predictions_bm25wp = pickle.load(f)
#     with open('data/dev_component_predictions/bm25_whole_not_ranked.pkl', 'rb') as f:
...
#     with open('data/dev_component_predictions/bm25_whole_predictions.pkl', 'wb') as f:
#         pickle.dump(predictions_bm25wp, f)
#     with open('data/dev_component_predictions/bm25_whole_not_ranked.pkl', 'wb') as f:
...
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
# if os.path.exists('data/dev_component_predictions/ne_linking_predictions.pkl') and os.path.exists('data/dev_component_predictions/ne_linking_not_ranked.pkl'):
#     with open('data/dev_component_predictions/ne_linking_predictions.pkl', 'rb') as f:
#         predictions_untr = pickle.load(f)
#     with open('data/dev_component_predictions/ne_linking_not_ranked.pkl', 'rb') as f:
...
#     with open('data/dev_component_predictions/ne_linking_predictions.pkl', 'wb') as f:
#         pickle.dump(predictions_untr, f)
#     with open('data/dev_component_predictions/ne_linking_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/token_linking_predictions.pkl') and os.path.exists('data/dev_component_predictions/token_linking_not_ranked.pkl'):
    with open('data/dev_component_predictions/token_linking_predictions.pkl', 'rb') as f:
        predictions_untr = pickle.load(f)
    with open('data/dev_component_predictions/token_linking_not_ranked.pkl', 'rb') as f:
        not_ranked_untr = pickle.load(f)
else:
    predictions_untr, not_ranked_untr = find_queries_with_seldom_tokens(current_queries_dict, id_to_abstract)
    with open('data/dev_component_predictions/token_linking_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_untr, f)
    with open('data/dev_component_predictions/token_linking_not_ranked.pkl', 'wb') as f:
        pickle.dump(not_ranked_untr, f)
final_predictions = final_predictions | predictions_untr
unresolved_queries &= set(not_ranked_untr)
resolved_now = set(current_queries) - set(not_ranked_untr)
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/journal_predictions_no_reranking.pkl') and os.path.exists('data/dev_component_predictions/journal_not_ranked.pkl'):
    with open('data/dev_component_predictions/journal_predictions_no_reranking.pkl', 'rb') as f:
        predictions_jd = pickle.load(f)
    with open('data/dev_component_predictions/journal_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/journal_predictions_no_reranking.pkl', 'wb') as f:
        pickle.dump(predictions_jd, f)
    with open('data/dev_component_predictions/journal_not_ranked_no_reranking.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/author_predictions.pkl') and os.path.exists('data/dev_component_predictions/author_not_ranked.pkl'):
    with open('data/dev_component_predictions/author_predictions.pkl', 'rb') as f:
        predictions_ad = pickle.load(f)
    with open('data/dev_component_predictions/author_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/author_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_ad, f)
    with open('data/dev_component_predictions/author_not_ranked.pkl', 'wb') as f:
...
# else:
#     predictions_mpnet_gt, not_ranked_mpnet_gt = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=generous_similarity_threshold_mpnet_gt, distance_threshold=generous_distance_threshold_mpnet_gt, model="mpnet", top_n=n_candidates)
#     with open('data/dev_component_predictions/mpnet_predictions.pkl', 'wb') as f:
...
if os.path.exists('data/dev_component_predictions/mpnet_ntf_predictions.pkl'):
    with open('data/dev_component_predictions/mpnet_ntf_predictions.pkl', 'rb') as f:
    ...
    all_predictions_mpnet_ntf, _ = rank_by_semantic_similarity(queries_dict, all_texts_with_summary,
                                                                        ...
                                                                        top_n=n_candidates)
    with open('data/dev_component_predictions/mpnet_ntf_predictions.pkl', 'wb') as f:
...
print("\n Component: Summary Summary Similarity")
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/summary_summary_predictions.pkl') and os.path.exists('data/dev_component_predictions/summary_summary_not_ranked.pkl'):
    with open('data/dev_component_predictions/summary_summary_predictions.pkl', 'rb') as f:
        predictions_ssus = pickle.load(f)
    with open('data/dev_component_predictions/summary_summary_not_ranked.pkl', 'rb') as f:
        not_ranked_ssus = pickle.load(f)
else:
    predictions_ssus, not_ranked_ssus = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold, distance_threshold=distance_threshold, top_n=n_candidates)
    with open('data/dev_component_predictions/summary_summary_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_ssus, f)
    with open('data/dev_component_predictions/summary_summary_not_ranked.pkl', 'wb') as f:
        pickle.dump(not_ranked_ssus, f)
final_predictions = final_predictions | predictions_ssus
unresolved_queries &= set(not_ranked_ssus)
resolved_now = set(current_queries) - set(not_ranked_ssus)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")

print(len(final_predictions))

print("\n Component: Summary Scientific Similarity summary_specter")
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/summary_specter_predictions.pkl') and os.path.exists('data/dev_component_predictions/summary_specter_not_ranked.pkl'):
    with open('data/dev_component_predictions/summary_specter_predictions.pkl', 'rb') as f:
        predictions_sspecs = pickle.load(f)
    with open('data/dev_component_predictions/summary_specter_not_ranked.pkl', 'rb') as f:
        not_ranked_sspecs = pickle.load(f)
else:
    predictions_sspecs, not_ranked_sspecs = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_spc, distance_threshold=distance_threshold_spc, model="specter", top_n=n_candidates)
    with open('data/dev_component_predictions/summary_specter_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_sspecs, f)
    with open('data/dev_component_predictions/summary_specter_not_ranked.pkl', 'wb') as f:
        pickle.dump(not_ranked_sspecs, f)
final_predictions= final_predictions | predictions_sspecs
unresolved_queries &= set(not_ranked_sspecs)
resolved_now = set(current_queries) - set(not_ranked_sspecs)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
# for key, value in current_queries_dict.items():
#     print(queries_dict[key])
#     print(id_to_summary[gold_dict[key]])
if os.path.exists('data/dev_component_predictions/mpnet_snt_predictions.pkl') and os.path.exists('data/dev_component_predictions/mpnet_snt_not_ranked.pkl'):
    with open('data/dev_component_predictions/mpnet_snt_predictions.pkl', 'rb') as f:
        predictions_mpnet_snt = pickle.load(f)
    with open('data/dev_component_predictions/mpnet_snt_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/dev_component_predictions/mpnet_snt_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_mpnet_snt, f)
    with open('data/dev_component_predictions/mpnet_snt_not_ranked.pkl', 'wb') as f:
...
print("\n Component: Final Summary Summary Similarity MPNET No Thresholds")
current_queries = list(unresolved_queries)
print(len(current_queries))
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
if os.path.exists('data/dev_component_predictions/mpnet_final_predictions.pkl') and os.path.exists('data/dev_component_predictions/mpnet_final_not_ranked.pkl'):
    with open('data/dev_component_predictions/mpnet_final_predictions.pkl', 'rb') as f:
        predictions_mpnet_final = pickle.load(f)
    with open('data/dev_component_predictions/mpnet_final_not_ranked.pkl', 'rb') as f:
        not_ranked_mpnet_final = pickle.load(f)
else:
    predictions_mpnet_final, not_ranked_mpnet_final = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=0, distance_threshold=0, model="mpnet", top_n=n_candidates)
    predictions_mpnet_final = rerank_queries_with_ollama(predictions_mpnet_final, queries_dict, data_dict, max_candidates=n_candidates, use_lm=True)
    with open('data/dev_component_predictions/mpnet_final_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_mpnet_final, f)
    with open('data/dev_component_predictions/mpnet_final_not_ranked.pkl', 'wb') as f:
        pickle.dump(not_ranked_mpnet_final, f)
final_predictions = final_predictions | predictions_mpnet_final
unresolved_queries &= set(not_ranked_mpnet_final)
resolved_now = set(current_queries) - set(not_ranked_mpnet_final)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
