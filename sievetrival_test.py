...
# Load test data (assuming it follows the same format as train/test)
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
if os.path.exists('data/test_component_predictions/journal_predictions_no_reranking.pkl') and os.path.exists('data/test_component_predictions/journal_not_ranked.pkl'):
    with open('data/test_component_predictions/journal_predictions_no_reranking.pkl', 'rb') as f:
    ...
    with open('data/test_component_predictions/journal_predictions_no_reranking.pkl', 'wb') as f:
        pickle.dump(predictions_jd, f)
    with open('data/test_component_predictions/journal_not_ranked_no_reranking.pkl', 'wb') as f:
...
if os.path.exists('data/test_component_predictions/summary_summary_predictions.pkl') and os.path.exists('data/test_component_predictions/summary_summary_not_ranked.pkl'):
    with open('data/test_component_predictions/summary_summary_predictions.pkl', 'rb') as f:
        predictions_ssus = pickle.load(f)
    with open('data/test_component_predictions/summary_summary_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/test_component_predictions/summary_summary_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_ssus, f)
    with open('data/test_component_predictions/summary_summary_not_ranked.pkl', 'wb') as f:
...
print("\n Component: Summary Scientific Similarity SPECTER")
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
if os.path.exists('data/test_component_predictions/summary_specter_predictions.pkl') and os.path.exists('data/test_component_predictions/summary_specter_not_ranked.pkl'):
    with open('data/test_component_predictions/summary_specter_predictions.pkl', 'rb') as f:
        predictions_sspecs = pickle.load(f)
    with open('data/test_component_predictions/summary_specter_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/test_component_predictions/summary_specter_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_sspecs, f)
    with open('data/test_component_predictions/summary_specter_not_ranked.pkl', 'wb') as f:
...
if os.path.exists('data/test_component_predictions/mpnet_snt_predictions.pkl') and os.path.exists('data/test_component_predictions/mpnet_snt_not_ranked.pkl'):
    with open('data/test_component_predictions/mpnet_snt_predictions.pkl', 'rb') as f:
        predictions_mpnet_snt = pickle.load(f)
    with open('data/test_component_predictions/mpnet_snt_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/test_component_predictions/mpnet_snt_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_mpnet_snt, f)
    with open('data/test_component_predictions/mpnet_snt_not_ranked.pkl', 'wb') as f:
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
if os.path.exists('data/test_component_predictions/mpnet_final_predictions.pkl') and os.path.exists('data/test_component_predictions/mpnet_final_not_ranked.pkl'):
    with open('data/test_component_predictions/mpnet_final_predictions.pkl', 'rb') as f:
        predictions_mpnet_final = pickle.load(f)
    with open('data/test_component_predictions/mpnet_final_not_ranked.pkl', 'rb') as f:
    ...
    with open('data/test_component_predictions/mpnet_final_predictions.pkl', 'wb') as f:
        pickle.dump(predictions_mpnet_final, f)
    with open('data/test_component_predictions/mpnet_final_not_ranked.pkl', 'wb') as f:
