...
print("\n Component: Summary Similarity MPNET Small")
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
predictions_suss, not_ranked_suss = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold, distance_threshold=distance_threshold, top_n=n_candidates, model="mini")
final_predictions = final_predictions | predictions_suss
unresolved_queries &= set(not_ranked_suss)
resolved_now = set(current_queries) - set(not_ranked_suss)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
print("Length of Final predictions: "+ str(len(final_predictions)))
...
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
predictions_mpnets, not_ranked_mpnets = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_mpnet, distance_threshold=distance_threshold_mpnet, top_n=n_candidates, model="mpnet")
final_predictions = final_predictions | predictions_mpnets
unresolved_queries &= set(not_ranked_mpnets)
resolved_now = set(current_queries) - set(not_ranked_mpnets)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
print("Length of Final predictions: "+ str(len(final_predictions)))
...
print("\n Component: Summary Similarity SPECTER")
current_queries = list(unresolved_queries)
current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
predictions_specters, not_ranked_specters = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_spc, distance_threshold=distance_threshold_spc, top_n=n_candidates, model="specter")
final_predictions = final_predictions | predictions_specters
unresolved_queries &= set(not_ranked_specters)
resolved_now = set(current_queries) - set(not_ranked_specters)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
print("Length of Final predictions: "+ str(len(final_predictions)))
...
# print("\n Component: Similarity bge")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
# predictions_bge, not_ranked_bge = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_bge, distance_threshold=distance_threshold_bge, top_n=n_candidates, model="bge")
...
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
# predictions_bges, not_ranked_bges = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_bge, distance_threshold=distance_threshold_bge, top_n=n_candidates, model="bge")
# final_predictions = final_predictions | predictions_bges
# unresolved_queries &= set(not_ranked_bges)
# resolved_now = set(current_queries) - set(not_ranked_bges)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))

# print("\n Component: Similarity gte")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
...
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
# predictions_gtes, not_ranked_gtes = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_gte, distance_threshold=distance_threshold_gte, top_n=n_candidates, model="gte")
# final_predictions = final_predictions | predictions_gtes
# unresolved_queries &= set(not_ranked_gtes)
# resolved_now = set(current_queries) - set(not_ranked_gtes)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))

# print("\n Component: Similarity e5")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
# predictions_e5, not_ranked_e5 = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_e5, distance_threshold=distance_threshold_e5, top_n=n_candidates, model="e5")
# final_predictions = final_predictions | predictions_e5
# unresolved_queries &= set(not_ranked_e5)
# resolved_now = set(current_queries) - set(not_ranked_e5)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))

# print("\n Component: Summary Similarity e5")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
# predictions_e5s, not_ranked_e5s = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold_e5, distance_threshold=distance_threshold_e5, top_n=n_candidates, model="e5")
# final_predictions = final_predictions | predictions_e5s
# unresolved_queries &= set(not_ranked_e5s)
# resolved_now = set(current_queries) - set(not_ranked_e5s)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))

# print("\n Component: Similarity t5")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: queries_dict[k] for k in current_queries}
# predictions_t5, not_ranked_t5 = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold, distance_threshold=distance_threshold, top_n=n_candidates, model="t5")
# final_predictions = final_predictions | predictions_t5
# unresolved_queries &= set(not_ranked_t5)
# resolved_now = set(current_queries) - set(not_ranked_t5)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))
# print(calculate_mrr_at5(final_predictions, gold_dict))
#
# print("\n Component: Summary Similarity t5")
# current_queries = list(unresolved_queries)
# current_queries_dict = {k: query_summaries_dict[k] for k in current_queries}
# predictions_t5s, not_ranked_t5s = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=similarity_threshold, distance_threshold=distance_threshold, top_n=n_candidates, model="t5")
# final_predictions = final_predictions | predictions_t5s
# unresolved_queries &= set(not_ranked_t5s)
# resolved_now = set(current_queries) - set(not_ranked_t5s)
# print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
# print("Length of Final predictions: "+ str(len(final_predictions)))
# print(calculate_mrr_at5(final_predictions, gold_dict))


print("\n Component: Summary Similarity MPNET Small Low Threshold")
current_queries = list(unresolved_queries)
current_queries_dict = {k: queries_dict[k] for k in current_queries}
predictions_suss, not_ranked_suss = rank_by_semantic_similarity(current_queries_dict, all_texts_with_summary, all_data_ids, similarity_threshold=0.65, distance_threshold=0, top_n=20, model="mini")
final_predictions = final_predictions | predictions_suss
unresolved_queries &= set(not_ranked_suss)
resolved_now = set(current_queries) - set(not_ranked_suss)
print(f"Resolved queries: {total_queries - len(unresolved_queries)}/{total_queries}")
...
#predictions_bge_final_test = rerank_queries_with_ollama(predictions_bge_final_test, query_summaries_dict, data_dict, max_candidates=20, use_lm=True)
...
with open('TEST_PREDICTIONS.tsv', 'w', newline='') as csvfile:
