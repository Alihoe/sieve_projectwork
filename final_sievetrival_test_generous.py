...
similarity_threshold_mpnet = mean_similarity_mpnet - std_similarity_mpnet
distance_threshold_mpnet = mean_distance_mpnet - std_distance_mpnet
...
similarity_threshold_spc = mean_similarity_spc - std_similarity_spc
distance_threshold_spc = mean_distance_spc - std_distance_spc
...
bm25_whole_papers_threshold = bm25_whole_papers_mean
...
# with open('TEST_PREDICTIONS_GENEROUS.tsv', 'w', newline='') as csvfile:
